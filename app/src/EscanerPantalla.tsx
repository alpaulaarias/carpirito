...
const EscanerPantalla: React.FC = () => {
  const navigation = useNavigation<EscanerScreenNavigationProp>();
        ...
        [
            { 
                ...
                onPress: () => {
                    ...
                    navigation.navigate("UserDataScreen", { userId: data });
                }
            },
            {
                text: "Cancelar",
...
export default EscanerPantalla;